...
export const InfoPaneLeft = () => {
  return (
    <Stack gap={4} direction="column">
      <InfoItem
        title={t('migrate-to-cloud.what-is-cloud.title', 'What is Rubix Dashboard?')}
      ...
      >
        ...
        Rubix Dashboard is a fully managed cloud-hosted observability platform ideal for cloud native environments.
          It&apos;s everything you love about Rubix Dashboard without the overhead of maintaining, upgrading, and supporting an
          installation.
        </Trans>
      </InfoItem>

      <InfoItem
        title={t('migrate-to-cloud.why-host.title', 'Why host with Rubix Dashboard?')}
      ...
      >
        <Trans i18nKey="migrate-to-cloud.why-host.body">
          In addition to the convenience of managed hosting, Rubix Dashboard includes many cloud-exclusive features like
      ...
      <InfoItem
        ...
        linkTitle={t('migrate-to-cloud.is-it-secure.link-title', 'Nube iO Trust Center')}
        linkHref="https://trust.grafana.com"
      >
        <Trans i18nKey="migrate-to-cloud.is-it-secure.body">
          Nube iO is committed to maintaining the highest standards of data privacy and security. By implementing
